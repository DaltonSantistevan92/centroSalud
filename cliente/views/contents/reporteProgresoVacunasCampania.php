<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0"> <b>Reporte Progreso de Vacunas Por Campaña</b> </h1>
            </div>
        </div>
    </div>
</div>
                            ...
                            <div class="col-12 mt-2">
                                <div class="row">
                                    <div class="col-6 col-md-8 col-lg-9" style="padding-left: 60px">
                                        ...
                                        <h6>Progreso de Vacunas Por Campaña</h6>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input id="buscar-campania" type="text" class="form-control"
                                placeholder="Ingrese nombre de la campaña a buscar">
                        </div>
                    </div>
                </div>
                                        ...
                                        <th>
                                            <div>
                                                <button class="btn btn-primary btn-sm"
                                                    onclick="seleccionar_campaniatodas(-1)">
...
<script src="<?=BASE?>views/dist/js/scripts/reporteProgresoVacunasCampania.js?ver=1.1.1.5"></script>