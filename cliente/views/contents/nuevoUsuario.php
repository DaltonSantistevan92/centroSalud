...
<div class="content">
            ...
            <div class="col-12 mt-3">
                <div class="card card-outline card-primary shadow-lg">
                    <div class="card-header d-flex p-0">
                        <h3 class="card-title p-3"> <b>Gestión de Usuarios</b> </h3>
                        <ul class="nav nav-pills ml-auto p-2">
                            <li class="nav-item"><a class="nav-link active" href="#tab_1" data-toggle="tab">Crear</a>
                            </li>
                            <li class="nav-item"><a class="nav-link" href="#tab_2" data-toggle="tab">Listar Usuarios</a>
                            </li>
                            <li class="nav-item"><a class="nav-link" href="#tab_3" data-toggle="tab">Listar Doctores</a>
                            </li>
                            <li class="nav-item"><a class="nav-link" href="#tab_4" data-toggle="tab">Listar Enfermeros</a>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body">
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_1">
                                <form id="form-datos-usuario" method="POST">
                                    <div class="row ">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-4 form-group">
                                            <label for="new-cargo">Cargo</label>
                                            <select id="new-cargo" class="form-control">
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="new-clave" type="password" name="clave"
                                                    class="form-control ">
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><i
                                                            class="fa-solid fa-lock"></i></i></span>
                                                </div>
                                                <input id="new-confclave" type="password" name="confclave"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-4 form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input" id="new-foto-usuario"
                                                        accept="image/*">
                                                    <label class="custom-file-label" for="new-foto-usuario">Subir
                                                        Foto</label>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card-body pb-0">
                                            <div id="listar-usuario" class="row"> </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane" id="tab_3">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card-body pb-0">
                                            <div id="listar-usuario-doctor" class="row"> </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane" id="tab_4">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card-body pb-0">
                                            <div id="listar-usuario-enfermero" class="row"> </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row ">
                                <div class="col-12 col-md-4 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="upd-cedula" type="text" name="cedula"
                                            class="form-control solo-numeros" maxlength="10" minlength="10" readOnly>
                                    </div>
                                </div>
                                <div class="col-12 col-md-4 form-group">
                                    <label for="">Nombre</label>
                                    <div class="input-group">
                                        ...
                                        <input id="upd-nombre" type="text" name="nombre"
                                            class="form-control solo-letras" maxlength="50" minlength="3">
                                    </div>
                                </div>
                                <div class="col-12 col-md-4 form-group">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-4 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="upd-celular" type="text" name="celular"
                                            class="form-control solo-numeros" maxlength="10" minlength="10">
                                    </div>
                                </div>
                                <div class="col-12 col-md-4 form-group">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-4 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="upd-usuario" type="text" name="usuario" class="form-control"
                                            maxlength="50" minlength="3">
                                    </div>
                                </div>
                                <div class="col-12 col-md-4 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="upd-correo" type="email" name="correo" class="form-control">
                                    </div>
                                </div>
                                <div class="col-12 col-md-4 form-group">
                                    <label for="upd-cargo">Cargo</label>
                                    <select id="upd-cargo" class="form-control" readOnly disabled>
                                    </select>
                                </div>
                            </div>
                        </form>
    ...
    <script src="<?=BASE?>views/dist/js/scripts/nuevoUsuario.js?ver=1.1.1.4"></script>