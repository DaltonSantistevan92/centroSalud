    ...
    <div class="container-fluid">
        <div class="row col-xs-12 d-flex justify-content-between">
            <div class="col-12 col-md-4 mt-3">
                <a class="btn btn-outline-primary form-control" href="<?= BASE ?>cita/nueva" data-backdrop="static"
                    data-keyboard="false">
...
<script src="<?=BASE?>views/dist/js/scripts/nuevoPaciente.js?ver=1.1.1.1"></script>